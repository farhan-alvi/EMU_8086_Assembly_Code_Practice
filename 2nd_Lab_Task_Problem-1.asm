...
MSG9 DB 0DH,0AH,'END OF REPORT','$'

MSG10 DB 0DH,0AH,"ENTER FIRST VALUE = $"
MSG11 DB 0DH,0AH,"ENTER SECOND VALUE = $" 
MSG12 DB 0DH,0AH, "THE RESULT IS = $" 
...
;============= DISPLAY END MESSAGE =============
    ...
    MOV AL,N1
    SUB AL, '0'   ;CONVERTING ASCII TO NUMBER   
     
    MOV BL,N2 
    SUB BL, '0'   ;CONVERTING ASCII TO NUMBER
    
    ADD AL,BL    ; ADDITION
    
    ADD AL,'0'   ;CONVERTING NUMBER TO ASCII 
